...
| [Domain-Driven Design (frontend)](topics/domain-driven-design-frontend.md) | 🔴 | 1.5h | `#ddd` | [DDD reference ⭐](https://www.domainlanguage.com/ddd/reference/) |
| [Dependency injection](topics/dependency-injection.md) | 🟡 | 45m | `#patterns` | [patterns.dev ⭐](https://www.patterns.dev/) |
...
| [Module Federation](topics/module-federation.md) | 🔴 | 1.5h | `#micro-frontends` `#bundling` | [Module Federation ⭐](https://module-federation.io/) |
| [Monorepos (Nx / Turborepo)](topics/monorepos-nx-turborepo.md) | 🔴 | 1.5h | `#monorepo` `#scale` | [Turborepo ⭐](https://turborepo.com/docs) |
| [Design systems](topics/design-systems.md) | 🔴 | 1.5h | `#design-systems` | [Design Systems Handbook ⭐](https://www.designbetter.co/design-systems-handbook) |
| [Component libraries & API design](topics/component-libraries-api-design.md) | 🟡 | 1h | `#components` `#design-systems` | [react.dev ⭐](https://react.dev/learn/sharing-state-between-components) |
...
| [Backend-for-Frontend (BFF)](topics/backend-for-frontend-bff.md) | 🟡 | 45m | `#api` `#architecture` | [samnewman.io: BFF ⭐](https://samnewman.io/patterns/architectural/bff/) |
| [Build tooling (Vite/Webpack/esbuild)](topics/build-tooling-vite-webpack-esbuild.md) | 🟡 | 1h | `#bundling` `#tooling` | [Vite ⭐](https://vitejs.dev/guide/why.html) |
| [Error handling & observability](topics/error-handling-observability.md) | 🟡 | 45m | `#reliability` | [Sentry docs ⭐](https://docs.sentry.io/) |
| [Feature flags & experimentation](topics/feature-flags-experimentation.md) | 🔴 | 1h | `#architecture` | [martinfowler.com ⭐](https://martinfowler.com/articles/feature-toggles.html) |
