...
> 📚 **[Full question bank — 548 JavaScript questions, 24 categories →](question-bank/README.md)** · [Output-based set (with answers)](output-based-questions.md)
...
|-------|:----------:|:----:|------|----------------|
| [`var` / `let` / `const`, scope, hoisting, TDZ](topics/var-let-const-scope-hoisting-tdz.md) | 🟢 | 45m | `#basics` | [javascript.info: variables ⭐](https://javascript.info/var) |
| [Data types & coercion (`==` vs `===`)](topics/data-types-coercion-vs.md) | 🟢 | 45m | `#basics` | [javascript.info: type conversions ⭐](https://javascript.info/type-conversions) |
| [Closures](topics/closures.md) | 🟡 | 1h | `#closures` | [javascript.info: closures ⭐](https://javascript.info/closure) |
| [`this` binding (4 rules)](topics/this-binding-4-rules.md) | 🟡 | 45m | `#this` | [javascript.info: this ⭐](https://javascript.info/object-methods) |
| [`call` / `apply` / `bind` (+ polyfills)](topics/call-apply-bind-polyfills.md) | 🟡 | 45m | `#this` `#polyfill` | [MDN: bind ⭐](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/bind) |
| [Prototypes & prototype chain](topics/prototypes-prototype-chain.md) | 🟡 | 1h | `#prototype` `#oop` | [javascript.info: prototypes ⭐](https://javascript.info/prototype-inheritance) |
| [Classes & inheritance](topics/classes-inheritance.md) | 🟡 | 45m | `#oop` | [javascript.info: classes ⭐](https://javascript.info/class) |
| [Objects, descriptors, getters/setters](topics/objects-descriptors-getters-setters.md) | 🟡 | 45m | `#objects` | [javascript.info: property flags ⭐](https://javascript.info/property-descriptors) |
| [Destructuring, spread, rest](topics/destructuring-spread-rest.md) | 🟢 | 30m | `#basics` | [javascript.info: destructuring ⭐](https://javascript.info/destructuring-assignment) |
| [Optional chaining & nullish coalescing](topics/optional-chaining-nullish-coalescing.md) | 🟢 | 20m | `#basics` | [MDN: optional chaining ⭐](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Optional_chaining) |
| [`Symbol` & well-known symbols](topics/symbol-well-known-symbols.md) | 🟡 | 30m | `#advanced` | [javascript.info: symbols ⭐](https://javascript.info/symbol) |
| [`Map` / `Set` vs objects/arrays](topics/map-set-vs-objects-arrays.md) | 🟢 | 30m | `#basics` | [javascript.info: Map/Set ⭐](https://javascript.info/map-set) |
...
| Topic | Difficulty | Time | Tags | Best Resources |
|-------|:----------:|:----:|------|----------------|
| [Higher-order functions](topics/higher-order-functions.md) | 🟢 | 30m | `#functional` | [javascript.info ⭐](https://javascript.info/) |
| [Currying & partial application](topics/currying-partial-application.md) | 🟡 | 45m | `#functional` | [javascript.info: currying ⭐](https://javascript.info/currying-partials) |
| [Composition (`pipe`/`compose`)](topics/composition-pipe-compose.md) | 🟡 | 30m | `#functional` | [BFE.dev ⭐](https://bigfrontend.dev/) |
| [Pure functions & immutability](topics/pure-functions-immutability.md) | 🟡 | 45m | `#functional` `#state` | [Immer docs ⭐](https://immerjs.github.io/immer/) |
| [Memoization](topics/memoization.md) | 🟡 | 30m | `#functional` `#performance` | [BFE.dev ⭐](https://bigfrontend.dev/) |
| [Generators](topics/generators.md) | 🔴 | 1h | `#generators` | [javascript.info: generators ⭐](https://javascript.info/generators) |
| [Iterators & iterables](topics/iterators-iterables.md) | 🟡 | 45m | `#iterators` | [javascript.info: iterables ⭐](https://javascript.info/iterable) |

## Modules, workers & advanced

| Topic | Difficulty | Time | Tags | Best Resources |
|-------|:----------:|:----:|------|----------------|
| [Modules (ESM vs CJS)](topics/modules-esm-vs-cjs.md) | 🟡 | 45m | `#modules` | [javascript.info: modules ⭐](https://javascript.info/modules-intro) |
| [Web Workers](topics/web-workers.md) | 🟡 | 1h | `#workers` `#performance` | [MDN: web workers ⭐](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers) |
| [Service Workers](topics/service-workers.md) | 🔴 | 1.5h | `#workers` `#offline` | [MDN: service workers ⭐](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API) |
| [Shared Workers](topics/shared-workers.md) | 🔴 | 45m | `#workers` | [MDN: SharedWorker ⭐](https://developer.mozilla.org/en-US/docs/Web/API/SharedWorker) |
